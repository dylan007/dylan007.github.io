...
![img.png](/images/posts/ml4t/img.png)
...
You can see that the final project is the only one with two clocks and, 
...
The rest of the projects were pretty easy. Each would take about 15-20 hours of your time.
...
## Review
Overall, I think this course had very little to do with Machine Learning as a concept. This course primarily 
deals with working on financial data, implementing simple algorithms to model this data and an attempt at 
making a functional automated trader.

The course content is quite stale, as the lectures are almost 7 years old now. They use the lectures recorded by 
